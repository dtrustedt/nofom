...
// =============================================================
// NOFOM CANONICAL SYMPTOM REGISTRY
// Schema version: nofom_clinical_intake v1.0.0
// Triage logic version: 1.0.0
// =============================================================
// Each symptom maps to:
//   canonical_code  — Nofom controlled vocabulary code
//   body_system     — from schema section 5.4 enum
//   urgency_weight  — contribution to suspicion score
//   is_red_flag     — direct red escalation trigger
//   observation_type — symptom | sign
// =============================================================
...
export const SYMPTOMS = [
  {
    ...
    is_red_flag:      true,
    explanation:
      'Unexplained weight loss (>10% body weight) is a primary indicator of ' +
      'pediatric malignancy, particularly lymphoma, leukemia, and solid tumors. ' +
  ...
  },
  {
    ...
    is_red_flag:      true,
    explanation:
      'Persistent fever without identified infection source lasting more than ' +
      '2 weeks is a classic B-symptom of lymphoma and may indicate leukemia or ' +
  ...
  },
  {
    ...
    is_red_flag:      true,
    explanation:
      'A palpable abdominal mass in a child is a red flag for Wilms tumor ' +
      '(nephroblastoma), neuroblastoma, or hepatoblastoma. Requires immediate ' +
      'imaging and oncology referral.'
  },
  {
    ...
    is_red_flag:      true,
    explanation:
      'Painless, progressive lymphadenopathy — especially cervical, axillary, ' +
      'or supraclavicular — is a hallmark of lymphoma and leukemia in children.'
  },
  {
    key:              'bone_pain',
    ...
    is_red_flag:      true,
    explanation:
      'Unexplained bone pain or limb swelling, especially at night or not ' +
      'related to trauma, may indicate osteosarcoma, Ewing sarcoma, or ' +
  ...
  },
  {
    ...
    is_red_flag:      false,
    explanation:
      'Petechiae, easy bruising, or unexplained bleeding may indicate ' +
      'thrombocytopenia caused by bone marrow infiltration in acute leukemia.'
  },
  {
    key:              'persistent_headache',
    canonical_code:   'SYM_HEADACHE_PROGRESSIVE_SEVERE',
    label:            'Persistent headache or morning vomiting',
    observation_type: 'symptom',
    body_system:      'neurologic',
    urgency_weight:   17,
    is_red_flag:      true,
    explanation:
      'Morning headache with vomiting may indicate raised intracranial pressure ' +
      'from a CNS tumor. Combined with other neurological signs, this is an ' +
  ...
  },
  {
    ...
    is_red_flag:      true,
    explanation:
      'Leukocoria (white pupil reflex) is the most common sign of ' +
      'retinoblastoma, a childhood eye cancer. Any visual change in a child ' +
      'under 6 requires urgent ophthalmology review.'
  },
  {
    key:              'extreme_fatigue',
    ...
    is_red_flag:      false,
    explanation:
      'Severe, unexplained fatigue and pallor may indicate anemia caused by ' +
      'bone marrow suppression in leukemia or other hematologic conditions.'
  }
]

// =============================================================
// URGENCY CLASSIFICATION
// Maps to schema section 5.5 urgency_level enum
// red = immediate, yellow = priority, green = scheduled
// =============================================================
...
// =============================================================
// RED FLAG OVERRIDE
// If N or more red_flag symptoms present → force immediate/red
// regardless of score
// =============================================================
export const RED_FLAG_OVERRIDE_THRESHOLD = 2

export const MAX_RAW_SCORE = SYMPTOMS.reduce((sum, s) => sum + s.urgency_weight, 0)
