...
// CommonJS version for backend — identical data to triageSchema.js
...
const PRIMARY_SYMPTOM_HIGH_OVERRIDE = 2
const MAX_RAW_SCORE = SYMPTOMS.reduce((sum, s) => sum + s.weight, 0)
